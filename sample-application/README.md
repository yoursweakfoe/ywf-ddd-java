...
| （刻意不演示）Portal/Gateway、Policy | 框架能力已备齐，完整示例见 `knowledge/docs/how-to/gateway.md`、`knowledge/docs/how-to/policy-pattern.md`；示例应用有意保持最小闭环，避免样例膨胀 |
...
> 真实业务项目引入本框架时，应删除整个 `sample-application/` 目录，以 `knowledge/docs/how-to/` 为模板从零搭建。
