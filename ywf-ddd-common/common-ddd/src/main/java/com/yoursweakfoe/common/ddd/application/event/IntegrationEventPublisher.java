package com.yoursweakfoe.common.ddd.application.event;
 ...
 *   <tr><td>{@link com.yoursweakfoe.common.ddd.application.event.DomainEventListener}</td><td>application/event/listener</td><td>内部领域事件入（消费）</td></tr>
 ...
 *   <tr><td>adapter Consumer</td><td>adapter/consumer</td><td>集成事件入（MQ）</td></tr>
 * </table>
 *
 ...
 * @see com.yoursweakfoe.common.ddd.domain.event.DomainEventPublisher
 */
