...
| `decisions/` | **判例卷宗**（在位冻结） | 正文不回改；推翻 = 新立案 + supersede 旧案；**到期整册彻底抹除、编号改元重启**（清册制） | `decisions/README.md` |
